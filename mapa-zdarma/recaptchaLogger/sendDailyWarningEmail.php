...
function sendDailyReport() {
    ...
    $logFile = $logDir . '/recaptcha_warnings_' . $yesterday . '.log';

    $to = 'podpora+mz_error@humandesign.cz';
    $subject = '[PHP MZ] Daily warning report for ' . $yesterday;
    ...
    if (file_exists($logFile)) {
        ...
        if ($logContents) {
			...
			$subject = '[PHP MZ - '. $firstLine .'] Daily warning report for ' . $yesterday;
            //$subject .= ' - ' . $firstLine;
