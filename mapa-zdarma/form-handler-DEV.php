...
showErrorAndSendEmailToAdmin("Debug: | " . $_SERVER['SCRIPT_NAME'], $_POST);
...
try {
    ...
    $_POST['recaptcha'] = ""; // Remove recaptcha to not save redundant data to SE custom field
    ...
    // If any error occurs in SE API request
